...
public interface FileStorageService {
    /**
     * Saves a file to the following directory: files/games/{@code gameType}/
     * @return The filepath to the saved file as it is saved in the database: games/{@code gameType}/
     */
